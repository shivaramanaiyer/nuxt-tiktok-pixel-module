...
export default (ctx, inject) => {
  ...
  if (typeof window !== "undefined") {
    ((w, d, t) => {
      ...
      if (pixelOptions.debug) document.cookie = "pixel_debug=true; expires=Thu, 18 Dec 2043 12:00:00 GMT; path=/; SameSite=None; Secure";
    })(window, document, "ttq");
  }
  /* eslint-enable */
  ...
  if (ctx.app && ctx.app.router) {
    ...
    router.afterEach(({ path }) => {
      if (parsedOptions.pixelId !== instance.options.pixelId) {
        instance.setPixelId(parsedOptions.pixelId);
      }

      /**
       * Automatically track ViewContent
       */
